      ...
      <main className="container py-16">
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Connecting innovative founders with strategic investors
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
          ...
          <div className="bg-background border border-border rounded-lg p-8 flex flex-col items-center shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-muted-foreground text-center mb-6">
              Looking to raise capital for your startup? Apply for KaasX funding and connect with strategic investors.
            </p>
