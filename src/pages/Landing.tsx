    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container py-16">
        <div className="mb-12 text-center">
          <h1 className="text-5xl font-bold tracking-tight mb-4">Raise funding from your earliest believers</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Welcome to the go-to platform for community fundraising.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
          ...
          <div className="bg-background border border-border rounded-lg p-8 flex flex-col items-center shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-muted-foreground text-center mb-6">
              Get early access to founders raising their first round and building what's next.
            </p>
