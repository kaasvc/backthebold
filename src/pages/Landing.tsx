      ...
      <main className="container py-16">
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Helping Europe's most loved startups raise their first round from strategic investors who bring more than capital, so founders can hit it out of the park from day one.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
          ...
          <div className="bg-background border border-border rounded-lg p-8 flex flex-col items-center shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-muted-foreground text-center mb-6">
              Get early access to Europe's most loved startups - invest in rounds alongside top backers.
            </p>
