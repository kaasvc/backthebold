      ...
      <main className="container py-16">
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Helping Europe's boldest founders raise their first round - backed by strategic investors who bring more than capital, to hit it out of the park from day one.
          </p>
        </div>
